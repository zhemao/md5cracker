...
add wave -radix hexadecimal {/md5unit_tb/md5/mccgen[0]/cc/step}
add wave -radix hexadecimal {/md5unit_tb/md5/mccgen[0]/cc/stage}
...
add wave -radix hexadecimal {/md5unit_tb/md5/mccgen[0]/cc/ireg}
